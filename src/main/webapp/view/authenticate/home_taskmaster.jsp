...
<head>
    ...
    <title>Taskmaster - Trang chủ</title>
    <link rel="stylesheet" href="css/home_taskmaster.css">
</head>
<body>
<header>
    <div class="logo">
        <img src="image/image 11.png" alt="Taskmaster Logo">
...
<main class="container">
    ...
    <div class="content">
        ...
        <p>Taskmaster tập hợp tất cả nhiệm vụ, thành viên nhóm và công cụ của bạn lại với nhau. Đơn giản, linh hoạt và
            mạnh mẽ.</p>
