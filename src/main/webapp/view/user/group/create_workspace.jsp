...
<div id="buildWorkspaceCart">
    <div id="inputInformationWorkspace">
        ...
        <label for="title">Tên không gian làm việc</label>
        <input id="title" type="text">
        <label for="description" >Mô tả không gian làm việc</label>
        <textarea id="description" placeholder="Nhóm của chúng tôi tổ chức mọi thứ ở đây"></textarea>
